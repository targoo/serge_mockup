				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<form id="contactForm" action="contact-us-advanced.php" method="POST" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="col-md-12">
										<input type="submit" value="Send Message" class="btn btn-primary btn-lg pull-right" data-loading-text="Loading...">
									</div>
								</div>
							</form>
						</div>
